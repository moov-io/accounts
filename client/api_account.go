...
/*
AccountApiService Create a new account for a Customer
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param customerId Customer Id
 * @param createAccount
@return InlineResponse200
*/
func (a *AccountApiService) CreateAccount(ctx context.Context, customerId string, createAccount CreateAccount) (InlineResponse200, *http.Response, error) {
	var (
...
/*
AccountApiService Retrieves a list of accounts associated with the customer ID.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param customerId Customer Id
@return []Account
*/
func (a *AccountApiService) GetAccountsByCustomerID(ctx context.Context, customerId string) ([]Account, *http.Response, error) {
	var (
